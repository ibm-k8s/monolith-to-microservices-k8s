...
git clone https://github.com/microservices89/petclinic-k8s
cd petclinic-k8s
...
chmod 777 ./scripts/*
export REPOSITORY_PREFIX=pariwesh01
...
Since these are standalone microservices, you can also `cd` into any of the project folders and build it indivisually (as well as push it to the registry).
...
To share this account, make sure the following is added to your configuration:
        ...
        management.metrics.export.wavefront.api-token=0dcb88f2-e2f6-445d-a4f4-e901d9a900c9
        management.metrics.export.wavefront.uri=https://wavefront.surf

Connect to your Wavefront dashboard using this one-time use link:
https://wavefront.surf/us/FNwqShYZST


Using generated security password: 553b21f8-6ec8-4171-94a6-b720c5df91c0
...
* Prometheus - http://localhost:9091
 ./jmeter -n -t  petclinic_test_plan.jmx
...
| Angular JS        | [app.js, controllers and templates](spring-petclinic-ui/src/scripts/)  |
 ...
 k delete deploy api-gateway customers-service vets-service visits-service  wavefront-proxy -n spring-petclinic
